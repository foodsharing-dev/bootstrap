...
function fs_filepointer($file) {
     ...
     */
    try {
        require_once __DIR__ . '/../../../platform' . $file;
    }
    catch(Exception $e) {
...
function fs_route() {
     ...
     */
    chdir(__DIR__ . '/../../../platform');

    /*
     * Hack the old autoloading
     */
    $files = glob(__DIR__ . '/../../../platform/lib/flourish/*.php');
    ...
    $load_before = [
        __DIR__ . '/../../../platform/lib/flourish/fException.php',
        __DIR__ . '/../../../platform/lib/flourish/fExpectedException.php',
        __DIR__ . '/../../../platform/lib/flourish/fUnexpectedException.php'
    ];
